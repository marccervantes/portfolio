    ...
    <nav className="border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                ...
                <button onClick={() => setMenuOpen(!menuOpen)} data-collapse-toggle="navbar-language" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 md:hidden" aria-controls="navbar-language" aria-expanded="false">
            ...
            <div className="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-language">
                <ul className={`${menuOpen ? 'flex' : 'hidden'} md:flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:bg-transparent bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0`}>
                    <li>
                        <a href="#projects" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700">{t('projects')}</a>
                    </li>
                    <li>
                        <a href="#about-me" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700" aria-current="page">{t('aboutMe')}</a>
                    </li>
                    <li>
                        <a href="#contact" className="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700" aria-current="page">{t('contact')}</a>
                    </li>
                </ul>
            </div>
        </div>
