export const translations = {
  en: {
    ...
    theSimpsons: "I developed a full-featured wiki application for The Simpsons, including detailed character profiles and interactive UI components. The project involved integrating REST APIs to fetch and process JSON data, designing reusable components, and implementing client-side logic to manage dynamic content efficiently. Built with modern web technologies, this project strengthened my skills in API integration, data handling, and scalable frontend architecture.",
    upNow: "Built a bilingual browser extension that periodically retrieves public YouTube and Twitch channel data, detects new content and live-stream events, and delivers configurable browser notifications while storing user preferences locally.",
  ...
  es: {
    ...
    theSimpsons: "Desarrollé una aplicación tipo wiki completa sobre *Los Simpson*, que incluye perfiles detallados de personajes y componentes de interfaz interactivos. El proyecto implicó la integración de APIs REST para obtener y procesar datos en formato JSON, el diseño de componentes reutilizables y la implementación de lógica en el cliente para gestionar contenido dinámico de forma eficiente. Desarrollado con tecnologías web modernas, este proyecto reforzó mis habilidades en integración de APIs, manejo de datos y arquitectura frontend escalable.",
    upNow: "Desarrollé una extensión de navegador bilingüe que consulta periódicamente datos públicos de canales de YouTube y Twitch, detecta nuevo contenido y transmisiones en directo, y genera notificaciones configurables, almacenando las preferencias del usuario localmente.",
